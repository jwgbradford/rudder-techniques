...
wget -P /target/run/mydir https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb
gdebi /target/run/mydir/google-chrome-stable_current_amd64.deb --non-interactive
rm /target/run/mydir/google-chrome-stable_current_amd64.deb

wget -P /target/run/mydir https://zoom.us/client/latest/zoom_amd64.deb
gdebi --non-interactive /target/temp-inst/zoom_amd64.deb
rm -f /target/run/mydir/zoom_amd64.deb
