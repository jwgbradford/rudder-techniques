...
echo "pip3 installs done"

#install snap packages
snap install slack --classic
echo "snap installs done"
...
apt full-upgrade -y
apt autoremove -y
echo "final updates run"

#check and update firmware
fwupdmgr refresh
fwupdmgr update -y
echo "firmware check and exit"
